...
from .ode_regression import ODERegressionWrapper, ODERegressionDemoCallback
from .trainer import Trainer

def train_ode_regression(
    model_path: str,
    ...
    demo_callback = ODERegressionDemoCallback(
        model=model,
        text_encoder=text_encoder,
        vae=vae,
